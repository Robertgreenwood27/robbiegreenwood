  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-10">
      <div className="max-w-lg mx-auto bg-transparent rounded-lg p-8">
        ...
        <div className="mb-8">
          <p className="text-xl font-semibold mb-2 text-white">Contact Information</p>
          <p>Phone: <a href="tel:719-287-2288" className="text-blue-300">719-287-2288</a></p>
          <p>Email: <a href="mailto:RobertGreenwood27@gmail.com" className="text-blue-300">RobertGreenwood27@gmail.com</a></p>
        </div>
        {emailSent && (
